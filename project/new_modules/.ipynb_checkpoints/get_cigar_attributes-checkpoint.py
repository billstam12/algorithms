...
def get_cigar_attributes(args, sam_file, toolname):
  
    annotated_ref_isoforms, annotated_splice_coordinates, annotated_splice_coordinates_pairs = get_annotated_splicesites(args.gtf, True, args.outfolder)
    ...
    torkel_primary_locations = get_error_profiles(sam_file, reads, refs, args)
    print_detailed_values_to_file(reads, detailed_results_outfile, toolname, torkel_primary_locations)
